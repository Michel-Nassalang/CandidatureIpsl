            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                            <h4 class="card-title">Recherche de candidats</h4>
                            <p class="card-description">
                                Recherchez le ou les candidats<code>→ Candidats</code> que vous voulez modifier.
                            </p>
                            <form class="form-inline">
                                <label class="sr-only" for="inlineFormInputName2">Prenom</label>
                                <input type="text" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="Exemple: Mouhamed">
                                <label class="sr-only" for="inlineFormInputName2">Nom</label>
                                <input type="text" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="Exemple: Sylla">
