                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            ...
                            <p class="card-description">
                                Consultation des<code>candidats</code>
                            </p>
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <td class="py-1">
                                        <?php 
                                            $path1 = "../../../images/profils/user_". $candidat['pseudo'] . ".png";
                                            $path2 = "../../../images/profils/user_". $candidat['pseudo'] . ".jpg";
                                            $path3 = "../../../images/profils/user_". $candidat['pseudo'] . ".jpeg";
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-info btn-sm" onclick="window.location.href ='page-candidat/?id= <?= $candidat['id_candidat'] ?>';">Consulter</button>
                                    </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
